export const AuctionHubLogoSVG = ({ size = 200 }: { size?: number }) => (
  <svg
  ...
  >
    ...
    <text x="100" y="152" textAnchor="middle" fontFamily="'Arial Black', 'Arial', sans-serif" fontWeight="900" fontSize="14" letterSpacing="1.5" fill="#e63946" filter="url(#glow)">AUCTION-HUB</text>
    <text x="100" y="165" textAnchor="middle" fontFamily="'Arial', sans-serif" fontWeight="400" fontSize="5.8" letterSpacing="0.8" fill="#ffffff" opacity="0.55">Fairness first. Every bid counts</text>

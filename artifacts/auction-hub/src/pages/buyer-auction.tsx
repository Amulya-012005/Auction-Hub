...
import { Clock, History, AlertTriangle, TrendingUp, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <Card className="glass-card border-primary/30 shadow-[0_0_30px_rgba(220,38,38,0.1)] relative overflow-hidden">
